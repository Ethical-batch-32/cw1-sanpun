...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse " id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link px-4" href="./index.html" style="color:  rgb(24,77,140); font-size: larger; ">About</a>
          </li>
          <li class="nav-item">
            <a class="nav-link px-4" href="./index.html" style="color:  rgb(24,77,140); font-size: larger; ">Reviews</a>
          </li>
          <li class="nav-item">
            <a class="nav-link px-4" href="#" style="color:  rgb(24,77,140); font-size: larger; ">Contact</a>
          </li>
          <li class="nav-item">
            <a class="nav-link px-4" href="#" style="color:  rgb(24,77,140); font-size: larger; ">Login</a>
          </li>
  ...
  <div class="container mt-4" style="padding: 10%;">
    <h3 class="trainingplan">Please Register Now</h3>
    <hr>
